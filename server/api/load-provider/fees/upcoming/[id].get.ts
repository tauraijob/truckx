...
export default defineEventHandler(async (event) => {
    console.log('Fetching upcoming platform fees for load provider')
    ...
    try {
        ...
        // Fetch the load provider and their orders
        ...
        // Flatten orders from all loads
        const orders = provider.loads.flatMap(load =>

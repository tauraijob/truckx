...
export default defineEventHandler(async (event) => {
    console.log('Fetching payment history for truck provider')
    ...
    try {
        ...
        // Fetch payment history for the truck provider
        ...
        console.error('Error fetching truck provider payment history:', error)
        throw createError({
            statusCode: 500,
